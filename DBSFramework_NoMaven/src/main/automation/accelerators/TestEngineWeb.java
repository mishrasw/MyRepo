...
public class TestEngineWeb {
	...
	public  String log4jConfPath = System.getProperty("user.dir") + "\\LogProperties\\log4j.properties";
	...
	public void beforeClass(String automationName, String browser, String browserVersion,String environment,String platformName,String nodeUrl) throws IOException, InterruptedException, ConfigurationException
	{
		PropertyConfigurator.configure(log4jConfPath);
		//generateLoggerConfig("Logs/"+browser+"_"+browserVersion+"_"+"log.log");
		//modifyLog4jProperties("Logs/"+browser+"_"+browserVersion+"_"+"log.log","Logs/"+browser+"_"+browserVersion+"_"+"log.html");
